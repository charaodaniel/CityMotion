...
function RegisterEmployeeForm({ onFormSubmit, existingEmployee }) {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      // No modo edição assume-se que já consentiu
    }
  });
  useEffect(() => {
  ...
  const employeeRoles = ["Motorista", "Motorista de Ambul\xE2ncia", "Motorista Escolar", "Secret\xE1rio(a)", "M\xE9dico(a)", "Enfermeiro(a)", "T\xE9cnico Administrativo", "Professor(a)", "Engenheiro(a)", "Operador de M\xE1quinas", "Gerente Geral", "Diretor", "CEO", "Coordenador de Setor", "Supervisor", "Estagi\xE1rio", "T\xE9cnico de TI"];
  ...
  )), /* @__PURE__ */ React.createElement(Separator, null), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold mb-4" }, "Documenta\xE7\xE3o"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-muted-foreground mb-4" }, isEditMode ? "Para alterar um documento, basta fazer um novo upload." : "O upload de documentos \xE9 criptografado e de acesso restrito."), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6" }, /* @__PURE__ */ React.createElement(
    FormField,
    {
      control: form.control,
      name: "idPhoto",
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "flex justify-end" }, /* @__PURE__ */ React.createElement(Button, { type: "submit", className: "w-full md:w-auto" }, isEditMode ? "Salvar Altera\xE7\xF5es" : "Cadastrar Colaborador"))));
}
export {
