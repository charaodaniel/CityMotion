...
function RegisterSectorForm({ onFormSubmit, existingSector }) {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "flex justify-end" }, /* @__PURE__ */ React.createElement(Button, { type: "submit", className: "w-full md:w-auto bg-accent hover:bg-accent/90" }, isEditMode ? "Salvar Altera\xE7\xF5es" : "Salvar Setor"))));
}
export {
  RegisterSectorForm
};
