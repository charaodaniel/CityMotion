...
function ReportIncidentForm({ schedule, onFormSubmit }) {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "flex justify-end pt-4" }, /* @__PURE__ */ React.createElement(Button, { type: "submit", variant: "destructive", className: "w-full md:w-auto h-10 font-bold uppercase tracking-widest text-xs" }, "Enviar Relat\xF3rio de Sinistro"))));
}
export {
  ReportIncidentForm
};
