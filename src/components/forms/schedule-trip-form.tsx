    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            {fields.map((field, index) => (
              <div key={field.id} className="flex items-center gap-4 p-4 border border-border/50 rounded-md bg-black/20">
                <div className="grid grid-cols-2 gap-4 flex-1">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[10px] uppercase font-bold text-muted-foreground">Nome</FormLabel>
                        <FormControl>
                          <Input placeholder="Nome completo" className="h-9 text-xs" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[10px] uppercase font-bold text-muted-foreground">CPF/RG</FormLabel>
                        <FormControl>
                          <Input placeholder="Número" className="h-9 text-xs" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
            ...
            {fields.length === 0 && (
              <p className="text-xs text-muted-foreground text-center py-4 border border-dashed rounded-md italic">Nenhum passageiro adicionado.</p>
            )}
          </div>
        </div>
        ...
        <div className="flex justify-end pt-4">
          <Button type="submit" className="w-full md:w-auto h-11 px-10 bg-primary text-primary-foreground font-black uppercase tracking-[0.2em] text-[10px]">
            Confirmar Missão
          </Button>
        </div>
      </form>
