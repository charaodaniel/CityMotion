...
function RegisterVehicleForm({ onFormSubmit, existingVehicle }) {
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-end" }, /* @__PURE__ */ React.createElement(Button, { type: "submit", className: "w-full md:w-auto bg-primary text-primary-foreground font-bold uppercase tracking-widest text-xs h-10" }, isEditMode ? "Salvar Altera\xE7\xF5es" : "Enviar Cadastro"))));
}
export {
  RegisterVehicleForm
};
