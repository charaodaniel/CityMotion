...
function ScheduleTripForm({ onFormSubmit }) {
  ...
  return /* @__PURE__ */ React.createElement(Form, { ...form }, /* @__PURE__ */ React.createElement("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-8" }, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement(Separator, null), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold mb-4" }, "Detalhes da Viagem"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6" }, /* @__PURE__ */ React.createElement(
    FormField,
    {
      control: form.control,
      name: "sector",
  ...
  )), /* @__PURE__ */ React.createElement(Separator, null), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold" }, "Passageiros"), /* @__PURE__ */ React.createElement(
    Button,
    {
      type: "button",
      variant: "outline",
    ...
    /* @__PURE__ */ React.createElement(UserPlus, { className: "mr-2 h-4 w-4" }),
    "Adicionar Passageiro"
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, fields.map((field, index) => /* @__PURE__ */ React.createElement("div", { key: field.id, className: "flex items-center gap-4 p-4 border rounded-md" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4 flex-1" }, /* @__PURE__ */ React.createElement(
    FormField,
    {
      control: form.control,
      name: `passengers.${index}.name`,
      render: ({ field: field2 }) => /* @__PURE__ */ React.createElement(FormItem, null, /* @__PURE__ */ React.createElement(FormLabel, null, "Nome do Passageiro"), /* @__PURE__ */ React.createElement(FormControl, null, /* @__PURE__ */ React.createElement(Input, { placeholder: "Nome completo", ...field2 })), /* @__PURE__ */ React.createElement(FormMessage, null))
    }
  ), /* @__PURE__ */ React.createElement(
    FormField,
    {
      ...
      render: ({ field: field2 }) => /* @__PURE__ */ React.createElement(FormItem, null, /* @__PURE__ */ React.createElement(FormLabel, null, "CPF/RG"), /* @__PURE__ */ React.createElement(FormControl, null, /* @__PURE__ */ React.createElement(Input, { placeholder: "N\xFAmero do documento", ...field2 })), /* @__PURE__ */ React.createElement(FormMessage, null))
    }
  )), /* @__PURE__ */ React.createElement(
    Button,
    {
  ...
  ))), fields.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "text-sm text-muted-foreground text-center py-4" }, "Nenhum passageiro adicionado."))), /* @__PURE__ */ React.createElement(
    FormField,
    {
      control: form.control,
      name: "description",
  ...
  ), /* @__PURE__ */ React.createElement(Button, { type: "submit", className: "w-full md:w-auto bg-primary hover:bg-primary/90" }, "Enviar Solicita\xE7\xE3o")));
}
export {
  ScheduleTripForm
};
