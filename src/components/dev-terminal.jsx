...
import { Terminal as TerminalIcon, X, Minus, Database, Server, Loader2 } from "lucide-react";
import { useApp } from "@/contexts/app-provider";
import { ScrollArea } from "./ui/scroll-area";
import { cn } from "@/lib/utils";
function DevTerminal({ isOpen, onClose }) {
  ...
  const executeActualCommand = async (cmd) => {
    ...
    switch (command) {
      case "nexus-db-reset":
        ...
        try {
          ...
          addLine("CONNECTION ERROR: Remote reset unavailable.", "error");
        }
        break;
    }
    ...
    switch (command) {
      ...
      case "nexus-health":
        ...
        try {
          ...
          addLine("NETWORK ERROR: Bridge disconnected", "error");
        }
        break;
      case "nexus-db-stats":
        ...
        try {
          ...
          addLine("ERROR: Unable to reach database metrics.", "error");
        }
        break;
      case "nexus-logdb":
        ...
        try {
          ...
          addLine("ERROR: Audit system unreachable.", "error");
        }
        break;
      case "nexus-integrity":
        ...
        try {
          ...
          addLine("ERROR: Integrity check failed.", "error");
        }
        break;
      case "cls":
      case "clear":
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-4 py-2 bg-zinc-900/80 border-b border-zinc-800 text-zinc-400 shrink-0 select-none" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(TerminalIcon, { className: cn("h-4 w-4 animate-pulse", isRoot ? "text-red-500" : "text-primary") }), /* @__PURE__ */ React.createElement("span", { className: cn("text-[10px] font-bold uppercase tracking-[0.2em]", isRoot ? "text-red-500" : "text-primary/90") }, "NexusOS Shell v2.4 ", isRoot && "// ROOT")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "hidden sm:flex items-center gap-3 text-[9px] uppercase tracking-widest opacity-50 mr-4" }, /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Database, { className: "h-2 w-2" }), " SQLite3"), /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1 text-emerald-400" }, /* @__PURE__ */ React.createElement(Server, { className: "h-2 w-2" }), " Online")), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsMinimized(!isMinimized), className: "hover:text-white transition-colors" }, /* @__PURE__ */ React.createElement(Minus, { className: "h-4 w-4" })), /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "hover:text-red-500 transition-colors" }, /* @__PURE__ */ React.createElement(X, { className: "h-4 w-4" })))),
    !isMinimized && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(ScrollArea, { className: "flex-1 p-6 relative" }, /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 tui-scanline opacity-[0.03] pointer-events-none" }), /* @__PURE__ */ React.createElement("div", { className: "space-y-1 relative z-10" }, history.map((line, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: cn(
    ...
    ) }, line.content)), isProcessing && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-primary animate-pulse text-[13px]" }, /* @__PURE__ */ React.createElement(Loader2, { className: "h-3 w-3 animate-spin" }), /* @__PURE__ */ React.createElement("span", null, "Processing sequence...")), /* @__PURE__ */ React.createElement("div", { ref: bottomRef }))), /* @__PURE__ */ React.createElement("form", { onSubmit: handleTerminalSubmit, className: "p-4 bg-zinc-900/40 border-t border-zinc-800 flex items-center gap-3 group" }, /* @__PURE__ */ React.createElement("span", { className: cn("font-bold animate-pulse group-focus-within:animate-none", isRoot ? "text-red-500" : "text-primary") }, mode === "password" ? "?" : isRoot ? "#" : "$"), /* @__PURE__ */ React.createElement(
      "input",
      {
        ref: inputRef,
        ...
        autoComplete: "off",
        spellCheck: "false",
        placeholder: mode === "confirm" ? "Confirm action (y/n)" : mode === "password" ? "Enter sudo password" : "Waiting for command..."
      }
    ), /* @__PURE__ */ React.createElement("div", { className: "hidden sm:block text-[9px] text-zinc-600 uppercase tracking-widest font-bold" }, "User: ", currentUser?.name?.split(" ")[0] || "ROOT")))
  );
}
export {
  DevTerminal
