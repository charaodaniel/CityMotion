...
export default function SettingsPage() {
  ...
  const onSubmit = (values: z.infer<typeof settingsSchema>) => {
    ...
    toast({
      ...
      description: "A identidade visual do sistema foi atualizada com sucesso.",
    });
  };
    ...
    <div className="container mx-auto p-4 sm:p-8 max-w-3xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Personalize a aparência do sistema com a identidade da sua organização.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
