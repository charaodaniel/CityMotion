...
function generateSvgIcon(size: number, isMaskable = false): string {
...
export default function manifest(): MetadataRoute.Manifest {
  return {
    name: 'CityMotion - Gestão Inteligente de Frota',
    short_name: 'CityMotion',
    description: 'Sistema Operacional de Gestão Inteligente de Frota e Mobilidade Corporativa',
    start_url: '/dashboard',
    display: 'standalone',
