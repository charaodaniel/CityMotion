...
const formSchema = z.object({
  title: z.string().min(5, "O título do deslocamento é obrigatório."),
  sector: z.string().min(1, "O setor solicitante é obrigatório."),
  category: z.string().min(1, "A categoria do deslocamento é obrigatória."),
...
export default function ScheduleTripPage() {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    toast({
      ...
      description: "A solicitação de deslocamento foi criada e aguarda aprovação.",
    });
  ...
  return (
    <div className="container mx-auto p-4 sm:p-8 max-w-3xl">
      <Card className="border-none shadow-none">
        <CardHeader>
          <CardTitle className="text-2xl">Agendar Novo Deslocamento</CardTitle>
          <CardDescription>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Título do Deslocamento</FormLabel>
                    <FormControl>
              ...
              {/* Detalhes da Viagem */}
              <div>
                <h3 className="text-lg font-semibold mb-4">Detalhes do Deslocamento</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Categoria do Deslocamento</FormLabel>
                        <Select
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Descreva o motivo do deslocamento, pessoas envolvidas ou outras informações relevantes."
