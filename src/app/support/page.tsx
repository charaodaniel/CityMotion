...
const faqItems = [
  {
    ...
    answer: "Na página 'Viagens', clique em 'Agendar Nova Viagem' e preencha o formulário com os detalhes do seu deslocamento. Sua solicitação será enviada para aprovação."
  },
  {
    question: "Quem aprova minha solicitação de viagem?",
    answer: "Viagens dentro do seu setor são aprovadas pelo seu gestor. Viagens para outros setores ou municípios são encaminhadas para o Secretário de Transporte."
  },
  {
