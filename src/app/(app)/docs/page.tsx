...
export default function DocsPage() {
  return (
    <>
      ...
      <p>
        A interface é dividida em seções principais, acessíveis através do menu lateral:
      </p>
      <ul>
        <li><strong>Painel de Controle:</strong> Uma visão geral e personalizada das atividades mais relevantes para o seu perfil.</li>
        <li><strong>Gestão de Recursos:</strong> Seções para gerenciar Veículos, Motoristas e Setores.</li>
        <li><strong>Operações:</strong> Páginas para acompanhar Viagens, Escalas e gerar Relatórios.</li>
        <li><strong>Seu Perfil:</strong> Acesse seu perfil, configurações e a central de suporte no menu do canto inferior esquerdo.</li>
      </ul>
