...
export default function RefuelingPage(container, Store, API) {
        ...
        <div class="scanlines rounded-lg border border-zinc-700/50 p-6 bg-zinc-900/30">
          <form id="refuelingForm" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label class="text-[10px] font-bold uppercase tracking-widest text-zinc-500 flex items-center gap-1">
  ...
  function setupEventListeners() {
    ...
    // Auto-preencher KM ao selecionar veículo
