/**
 * CityMotion — Perfil: Modais e Renderizadores HTML
...
export function renderProfileCard(user, sectorStr) {
...
export function renderLgpdCard() {
  return `
...
export function renderHistoryTable(requests, formatDate, getBadgeClass, getStatusVariant) {
  return `
