...
const refuelings = sqliteTable("refuelings", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
const maintenanceRequests = sqliteTable("maintenance_requests", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  vehicleId: text("vehicle_id").notNull(),
  vehicleModel: text("vehicle_model"),
  licensePlate: text("license_plate"),
...
const workSchedules = sqliteTable("work_schedules", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  title: text("title").notNull(),
...
const vehicleRequests = sqliteTable("vehicle_requests", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  title: text("title").notNull(),
  sector: text("sector"),
  details: text("details"),
...
const sectors = sqliteTable("sectors", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  name: text("name").notNull(),
  organizationId: text("organization_id"),
  createdAt: text("created_at").default(sql`(datetime('now'))`)
});
const reportTemplates = sqliteTable("report_templates", {
  id: integer("id").primaryKey({ autoIncrement: true }),
